...
#define XSDATAPACKET_INITIALIZER	{ XSMESSAGE_INITIALIZER, XSMESSAGE_INITIALIZER, XSDEVICEID_INITIALIZER, XDI_None, -1, 0, 0, XSTIMESTAMP_INITIALIZER, 0}
#endif
...
XSTYPES_DLL_API void XsDataPacket_swapMessage(XsDataPacket* thisPtr, XsMessage* msg);
...
XSTYPES_DLL_API XsVector* XsDataPacket_convertRawVector(const XsDataPacket* thisPtr, const XsUShortVector* input, XsVector* returnVal);
XSTYPES_DLL_API XsVector* XsDataPacket_convertRawVectorById(const XsUShortVector* input, XsVector* returnVal, XsDataIdentifier id);
...
struct XsDataPacket {
	...
	*/
	...
	//! \copydoc XsDataPacket_swapMessage
	inline void swapMessage(XsMessage& msg)
	{
		XsDataPacket_swapMessage(this, &msg);
	}
	...
	*/
	...
	/*! \brief \copybrief XsDataPacket_convertRawVector */
	inline XsVector convertRawVector(const XsUShortVector &input)
	{
		XsVector v;
		return *XsDataPacket_convertRawVector(this, &input, &v);
	}

	/*! \brief \copybrief XsDataPacket_convertRawVectorById */
	static inline XsVector convertRawVector(const XsUShortVector &input, XsDataIdentifier id)
	{
		XsVector v;
		return *XsDataPacket_convertRawVectorById(&input, &v, id);
	}
