...
enum XsResultValue {
	...
	,XRV_INVALIDFILTERPROFILE   = 49	//!< 49: Specified filter profile ID is not available on the device or the user nis trying to duplicate an existing filter profile type
