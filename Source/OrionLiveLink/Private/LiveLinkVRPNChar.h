...
#pragma once
#include "LiveLinkVRPNChar.generated.h"
class vrpn_Text_Sender;
class vrpn_Text_Receiver;
class vrpn_Tracker_Remote;

USTRUCT()
struct FLiveLinkVRPNBones
{
...
struct FLiveLinkVRPNChar 
{
	...
	FLiveLinkVRPNChar();
	FLiveLinkVRPNChar(const FName& name);;
	FLiveLinkVRPNChar(const FLiveLinkVRPNChar& other);
	FLiveLinkVRPNChar operator=(const FLiveLinkVRPNChar& other);
	~FLiveLinkVRPNChar();
	...
	UPROPERTY()
	TArray<FLiveLinkVRPNBones> Bones;
